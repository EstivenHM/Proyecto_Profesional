...
<header>
    ...
    <section>
        ...
        <div class="acerca">
            <h1 class="title">RECWEB</h1><br>
            <h2 class="subtitle">Robert English Coach</h2><br>
            <p class="version">Versión 1.0</p><br>
            <p class="date">Fecha de versión: 20 de febrero del 2025</p><br>
            <p class="owner">Propiedad: Roberto Cascante Murillo</p><br>
            <p class="developer">Desarrollador: Estiven Hurtado Munguía</p><br>
            <p class="tools">Desarrollado en Microsoft Visual Studio Code</p><br>
            <p class="tech">PHP/HTML con MySQL como motor de base de datos</p><br>
        </div>
        </div>
